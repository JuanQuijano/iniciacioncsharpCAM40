...
Console.WriteLine($"BankCustomer 1: {customer1.DisplayCustomerInfo()}");
Console.WriteLine($"BankCustomer 2: {customer2.DisplayCustomerInfo()}");
Console.WriteLine($"BankCustomer 3: {customer3.DisplayCustomerInfo()}");
